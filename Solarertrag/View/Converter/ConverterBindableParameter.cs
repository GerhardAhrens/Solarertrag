...
public class ConverterBindableParameter : MarkupExtension
    {
        ...
        private class MultiValueConverterAdapter : IMultiValueConverter
        {
            ...
            {
                if (this.Converter == null) return new object[] { value }; // Required for VS design-time

                return new object[] { this.Converter.ConvertBack(value, targetTypes[0], lastParameter, culture) };
            }
        }
    }
}
